...
const PrestadorModalReporte = ({ route, navigation }) => {
  ...
  const handleEnviar = async () => {
    try {
      ...
      data.append('idReportado', ordenServicio.empleador._id)
      data.append('idReportador', ordenServicio.prestador._id)
...
export default PrestadorModalReporte
